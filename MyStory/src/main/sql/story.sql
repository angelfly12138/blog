...
INSERT INTO `t_options` VALUES ('site_description', '本站是hongfei.zhang的技术分享博客。涵盖生活故事、专注Java后端技术、SpringBoot、SpringCloud、微服务架构、高可用架构、中间件使用、系统监控等相关的研究与知识分享。', null);
INSERT INTO `t_options` VALUES ('site_keywords', '农码一生,农码一生为了谁,hongfei.zhang,hongfei.zhang个人博客,zhangjianbing,张建兵,springboot,springcloud,java,并发编程,jvm,架构,技术分享,技术干货,系统架构,个人网站,生活随笔,开发者,编程,代码,开源,IT网站,IT技术博客', null);
...
-- ----------------------------
BEGIN;
INSERT INTO `t_users` VALUES ('1', 'admin', '9400feec28101f42f299a0d95794a6a3', '449246146@qq.com', null, '张老三', '1525759224', null, '1525759237', null), ('2', 'zhangsan', '123456', '449246146@qq.com', null, '张三', '1525759224', null, '1525759237', null);
COMMIT;
